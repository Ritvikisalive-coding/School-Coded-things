from tkinter import *#NEEDED IN ALL PROJECTS
from tkinter import ttk#For App Window Tabs
import tkinter #Needed if commands clash and tkinter. is required 
...
from os import path#For asking in file explorer
